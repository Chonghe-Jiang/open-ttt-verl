# Polyomino Modal Single-Summary Step

Source: Modal volume `guidance-ttt-runs`, path `/runs/guidance_ttt/polyomino_modal_h200_2gpu_single_summary/library.json`.

Run context:

- Training run: `ap-vUiOP8Tz8EFEb7Yw56JuF2`
- Prune/validation run: `ap-srIKEm35rjq8f5JryCGovv`
- Guidance actor: `Qwen/Qwen3-8B`
- Execution model: `openai/gpt-oss-20b` via `local_vllm`
...
- Guidance attempts: `1`
- Guidance stop reason: `completed`
- Execution fallback used: `False`
- Verification message: `accepted`
...
This is the execution model's full output after receiving the guidance.
...
This is the summary stored on the final single library entry.
...
- Problem id: `0`
- FrontierCS base dir: `/opt/Frontier-CS`
