...
POLYOMINO_PROBLEM_PROMPT = """You are solving FrontierCS algorithmic problem 0: Polyomino Packing.
    ...
    root.metadata.update(
        {
            ...
            "frontiercs_problem_id": "0",
            "initialization": "empty_frontiercs_score",
        }
    )
    return root
