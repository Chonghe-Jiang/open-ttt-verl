...
MODEL_DIR=${MODEL_DIR:-${MODEL_ROOT}/Qwen3-8B}
...
LOG_FILE=${LOG_FILE:-${LOG_ROOT}/download_qwen3_8b_$(date +%Y%m%d_%H%M%S).log}
touch "${LOG_FILE}"
rm -f "${LOG_ROOT}/download_qwen3_8b.latest.log"
ln -s "${LOG_FILE}" "${LOG_ROOT}/download_qwen3_8b.latest.log"
