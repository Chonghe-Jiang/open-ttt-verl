...
CONFIG="${CONFIG:-guidance_ttt/config/trimul_b200_1gpu_qwen3_8b_evolvent_glm52_thinking_cache_batch8_group16_30step.yaml}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/guidance_ttt/trimul_b200_glm52_thinking_cache_g8x16_30step_${SLURM_JOB_ID:-manual}}"
