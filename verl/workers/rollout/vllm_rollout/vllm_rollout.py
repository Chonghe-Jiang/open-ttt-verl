...
from verl.workers.rollout.vllm_rollout.utils import get_device_uuid, get_zmq_handle_for_device_uuid
...
class ServerAdapter(BaseRollout):
    ...
    def __init__(
        ...
        self.zmq_handle = get_zmq_handle_for_device_uuid(self.device_uuid)
